...
{
    Design::TxtOutline(-7,0,14,1);
    H::foreColor(7); H::gotoxy(41,3); cout<<R"(    ___     _      _           ___                          ___      _        )";
    H::foreColor(7); H::gotoxy(41,4); cout<<R"(   /   \___| | ___| |_ ___    / _ \__ _ _ __ ___   ___     /   \__ _| |_ __ _ )";
    H::foreColor(1); H::gotoxy(41,5); cout<<R"(  / /\ / _ \ |/ _ \ __/ _ \  / /_\/ _` | '_ ` _ \ / _ \   / /\ / _` | __/ _` |)";
    H::foreColor(7); H::gotoxy(41,6); cout<<R"( / /_//  __/ |  __/ ||  __/ / /_\\ (_| | | | | | |  __/  / /_// (_| | || (_| |)";
    H::foreColor(7); H::gotoxy(41,7); cout<<R"(/___,' \___|_|\___|\__\___| \____/\__,_|_| |_| |_|\___| /___,' \__,_|\__\__,_|)";
}
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
void BLT::DeleteGameDesign::DeleteGame_Animation()
{
