...
void BLT::GameMenu::GameMenu_Design()
{
    ...
    H::setcolor(7); H::gotoxy(22,17); cout << R"(     |/|  | )";   H::setcolor(14); H::gotoxy(70,17); cout << R"(| )"; H::setcolor(3); cout << R"(|/|   )"; H::setcolor(4); cout << R"(******)"; H::setcolor(3); cout << R"(   |/|)"; H::setcolor(6); cout << R"( |)";   H::setcolor(7); H::gotoxy(128,17); cout << R"( |[]|\|     )";
    H::setcolor(7); H::gotoxy(22,18); cout << R"(    ;     | )";   H::setcolor(14); H::gotoxy(70,18); cout << R"(| )"; H::setcolor(3); cout << R"(|o|   )"; H::setcolor(4); cout << R"( B L T)"; H::setcolor(3); cout << R"(   |/|)"; H::setcolor(6); cout << R"( |)";   H::setcolor(7); H::gotoxy(128,18); cout << R"( |[]|  ;    )";
    H::setcolor(7); H::gotoxy(22,19); cout << R"(    ;/": E| )";   H::setcolor(14); H::gotoxy(70,19); cout << R"(| )"; H::setcolor(3); cout << R"(|/|   )"; H::setcolor(4); cout << R"(******)"; H::setcolor(3); cout << R"(   |/|)"; H::setcolor(6); cout << R"( |)";   H::setcolor(7); H::gotoxy(128,19); cout << R"( |Of|  ;    )";
    ...
    H::setcolor(7); H::gotoxy(22,33); cout << R"(      "'--' )";   H::setcolor(14); H::gotoxy(70,33); cout << R"(     """"""""""""     )";   H::setcolor(7); H::gotoxy(128,33); cout << R"( '--'")";
