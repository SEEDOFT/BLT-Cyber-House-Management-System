...
{   
    ...
    H::gotoxy(29,20); H::foreColor(224); cout<<R"(| |)";H::foreColor(233); cout<<R"( (\-:###/7\###;-/) )";H::foreColor(224); cout<<R"(|      )";H::foreColor(233); cout<<R"(MEMBER SINCE:      )";H::foreColor(236); cout<<R"(01/July/2024                                         )";H::foreColor(224); cout<<R"(|)";
    ...
    H::gotoxy(29,23); H::foreColor(224); cout<<R"(| |)";H::foreColor(233); cout<<R"(   :    ---    ;   )";H::foreColor(224); cout<<R"(|      )";H::foreColor(233); cout<<R"(ADRESS      :      ANT TECHNOLOGY CENTER                                )";H::foreColor(224); cout<<R"(|)";
    H::gotoxy(29,24); H::foreColor(224); cout<<R"(| |)";H::foreColor(233); cout<<R"(    ';   "   ;'    )";H::foreColor(224); cout<<R"(|      )";H::foreColor(233); cout<<R"(EMAIL       :      bltCyberHouse@yahoo.com                              )";H::foreColor(224); cout<<R"(|)";
