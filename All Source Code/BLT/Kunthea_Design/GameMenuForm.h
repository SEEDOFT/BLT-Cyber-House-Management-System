...
{
    H::foreColor(3); H::gotoxy(38,1); cout<<R"(  ________                           _____                       )";
    H::foreColor(3); H::gotoxy(38,2); cout<<R"( /  _____/_____    _____   ____     /     \   ____   ____  __ __ )";
    H::foreColor(3); H::gotoxy(38,3); cout<<R"(/   \  ___\__  \  /     \_/ __ \   /  \ /  \_/ __ \ /    \|  |  \)";
    H::foreColor(4); H::gotoxy(38,4); cout<<R"(\    \_\  \/ __ \|  Y Y  \  ___/  /    Y    \  ___/|   |  \  |  /)";
    H::foreColor(4); H::gotoxy(38,5); cout<<R"( \______  (____  /__|_|  /\___  > \____|__  /\___  >___|  /____/ )";
    H::foreColor(4); H::gotoxy(38,6); cout<<R"(        \/     \/      \/     \/          \/     \/     \/       )";
